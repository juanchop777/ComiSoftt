...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            ...
            <div id="individualTable_wrapper" class="p-6">
            ...
            <table id="individualTable" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Aprendiz</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($committees as $c)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $c->trainee_name }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-6 text-center text-gray-500">No hay comités individuales registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        const tableElement = document.querySelector('#individualTable');
        if (!tableElement) {
            console.error('No se encontró la tabla con id #individualTable');
            return;
        }
        ...
        let table = new DataTable('#individualTable', {
        language: {
            search: 'Buscar:',
        ...
        initComplete: function() {
            ...
            lengthContainer.innerHTML = `
                <label>
                    Mostrar
                    <select name="individualTable_length" aria-controls="individualTable" class="px-3 py-2 border border-gray-300 rounded-lg ml-2">
            ...
            filterContainer.innerHTML = `
                <label>
                    Buscar:
                    <input type="search" class="px-3 py-2 border border-gray-300 rounded-lg ml-2" placeholder="Buscar..." aria-controls="individualTable" style="width: 250px; outline: none; transition: none;">
                </label>
            `;
