...
<div class="min-h-screen bg-gray-50 py-8">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('committee.general.update', $generalCommittee) }}" method="POST" class="space-y-8">
        ...
        @if($minutesForAct->count() > 0 && $minutesForAct->first()->reportingPerson)
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-purple-100 hover:shadow-md transition-all duration-200">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm text-gray-800 font-medium bg-purple-50 px-3 py-1 rounded-full">{{ $minutesForAct->first()->reportingPerson->full_name ?: 'No especificado' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-purple-100 hover:shadow-md transition-all duration-200">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm text-gray-800 bg-purple-50 px-3 py-1 rounded-full break-all">{{ $minutesForAct->first()->reportingPerson->email ?: 'No especificado' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-purple-100 hover:shadow-md transition-all duration-200">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm text-gray-800 bg-purple-50 px-3 py-1 rounded-full">{{ $minutesForAct->first()->reportingPerson->phone ?: 'No especificado' }}</span>
                        </div>
                    </div>
                </div>
            </div>
